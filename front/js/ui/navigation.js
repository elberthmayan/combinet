/**
 * Renderiza o header de navegação (desktop e mobile) e anexa seus eventos.
 ...
 */
export function renderNavigation(container, router) {
    container.innerHTML = `
        <nav class="navbar">
            <!-- NOVO: Container para itens da esquerda (Menu e Logo) -->
            <div class="navbar__left">
                 <button class="navbar__toggle" id="mobile-menu-toggle" aria-label="Abrir menu">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
                <a href="#" class="navbar__brand" data-page="combinar">Combinet</a>
            </div>
            
            <!-- Links para Desktop -->
            <div class="navbar__links--desktop">
                <a href="#" data-page="combinar" class="active">Combinar</a>
                <a href="#" data-page="favoritos">Favoritos</a>
                <a href="#" data-page="social">Comunidade</a>
            </div>

            <!-- Ações da Direita (AGORA SEM O MENU HAMBURGUER) -->
            <div class="navbar__actions">
                ...
                <a href="#" class="navbar__user-icon" aria-label="Perfil do usuário">
        ...
        <div class="navbar__links--mobile" id="mobile-menu">
            <a href="#" data-page="combinar" class="active">Combinar</a>
            <a href="#" data-page="favoritos">Favoritos</a>
            <a href="#" data-page="social">Comunidade</a>
        </div>
    ...
    // Listener de clique para o roteamento
    container.addEventListener('click', (e) => {
        ...
        if (targetLink) {
            ...
            // Se o menu mobile estiver aberto, fecha ao clicar em um link
